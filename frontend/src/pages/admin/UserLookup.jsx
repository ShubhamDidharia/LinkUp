...
const UserLookup = () => {
    ...
    return (
        <div className="p-8 space-y-8 animate-fade-in max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSearch} className="flex gap-3">
                <div className="relative flex-1">
                    ...
                    <input 
                        ...
                        className="input input-bordered pl-10 bg-slate-900 border-slate-800 text-slate-100 text-sm focus:border-theme-purple w-full rounded-xl py-6"
                    />
                </div>
                <button 
                    type="submit" 
                    disabled={searching}
                    className="btn bg-theme-purple hover:bg-theme-purple/80 disabled:opacity-50 text-white border-none px-8 rounded-xl font-bold flex items-center gap-2"
                >
            ...
            {user ? (
                <div className="card bg-theme-dark/80 border border-theme-purple/20 shadow-xl rounded-2xl overflow-hidden mt-6">
                    <div className="p-6 border-b border-slate-850 bg-slate-850/20 flex flex-wrap justify-between items-center gap-3">
                        ...
                        <div className="flex gap-2">
                            ...
                            {user.role === "admin" && (
                                <span className="px-2.5 py-1 bg-theme-pink/10 text-theme-pink border border-theme-pink/20 rounded-full text-xs font-bold uppercase">
                                    Admin
                                </span>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-950 border border-slate-850/50 p-6 rounded-2xl">
                            <div className="space-y-4">
                                <div className="flex items-center gap-2.5 text-sm text-slate-400">
                                    <FaEnvelope className="text-theme-purple" />
                            ...
                            <div className="space-y-2 border-t md:border-t-0 md:border-l border-slate-850/80 pt-4 md:pt-0 md:pl-6">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-3xl font-black text-theme-coral">{user.strikes || 0}</span>
                        ...
                        <div className="space-y-3 pt-2">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <button 
                                    ...
                                    className="btn bg-theme-yellow hover:bg-theme-yellow/80 disabled:opacity-40 text-white border-none px-6 rounded-xl font-bold flex-1 flex items-center gap-2"
                                >
                                ...
                                <button 
                                    ...
                                    className="btn bg-theme-coral hover:bg-theme-coral/80 disabled:opacity-40 text-white border-none px-6 rounded-xl font-bold flex-1 flex items-center gap-2"
                                >
                                    <FaUserTimes />
                                ...
                                <button 
                                    ...
                                    className="btn bg-theme-purple hover:bg-theme-purple/80 disabled:opacity-40 text-white border-none px-6 rounded-xl font-bold flex-1 flex items-center gap-2"
                                >
                                    <FaUserCheck />
